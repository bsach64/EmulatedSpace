...
/*
    *codebuffer is a vaild pointer to 8080 assembly code 
...
int Disassemble8080op(unsigned char *codebuffer, int pc)
{
    ...
    int opbytes = 1;
    // Prints the value of pc in hexadecimal format
    printf("%04x ",pc);   
    switch(*code)
    {
...
/*
    ...
    It compares the value of the variable with the case label,
    which in this case are 1 and 2.
    It executes the default statement when it matches no case.
*/